...
export default function VendorSidebar({ collapsed, onToggle, mobileOpen, onCloseMobile }) {
  ...
  return (
    <aside className={`admin-sidebar${isCollapsed ? ' collapsed' : ''}${mobileOpen ? ' mobile-open' : ''}`}>
      ...
      <div className="admin-sidebar-logo">
        ...
        {!isCollapsed && <span className="logo-text">Vendor</span>}
        <button
        ...
        <button
          className="sidebar-toggle desktop-collapse-toggle"
          onClick={onToggle}
      ...
      <nav className="admin-sidebar-nav">
        {NAV.map((group) => (
          <div className="admin-nav-section" key={group.section}>
            {!isCollapsed && <div className="admin-nav-section-label">{group.section}</div>}
