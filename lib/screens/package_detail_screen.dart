...
class _PackageDetailScreenState extends State<PackageDetailScreen> {
  ...
  List<String> get _allImageUrls {
    ...
    urls.addAll(
        _fullPackage.galleryImageUrls.where((u) => u.isNotEmpty && u != cover));
    return urls;
  }
  ...
  List<PackageItem> get _coreItems =>
      _allItems.where((i) => !i.isOptional).toList();
  List<PackageItem> get _optionalItems =>
      _allItems.where((i) => i.isOptional).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              slivers: [
                SliverAppBar(
                  ...
                  leading: Padding(
                    ...
                    child: _glassIcon(context, Icons.chevron_left_rounded,
                  ...
                  delegate: SliverChildListDelegate([
                    Padding(
                      padding: EdgeInsets.fromLTRB(
                          resp.w(20), resp.h(12), resp.w(20), resp.h(120)),
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(_fullPackage.name,
                              style:
                                  TyType.display(resp.sp(32), color: ty.ink)),
                          SizedBox(height: resp.h(12)),
                          Text(_fullPackage.description ?? '',
                          ...
                          if (_optionalItems.isNotEmpty) ...[
                            ...
                            SizedBox(height: resp.h(16)),
                            ..._optionalItems
                                .map((item) => _packageItemRow(context, item)),
                          ],
                        ],
                      ),
                    ),
      ...
      bottomSheet: _isLoading
          ? null
          : Container(
              padding: EdgeInsets.fromLTRB(resp.w(20), resp.h(16), resp.w(20),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(formatPrice(_totalPrice),
                            style: TyType.display(resp.sp(24), color: ty.ink)),
                      ],
                    ),
                  ),
          ...
          child: GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(
                  horizontal: resp.w(14), vertical: resp.h(9)),
              decoration: BoxDecoration(
                color: Colors.white,
                ...
                children: [
                  ...
                  if (item.description != null && item.description!.isNotEmpty)
                    Text(item.description!,
                        style: TyType.sans(resp.sp(12), color: ty.ink3)),
                ],
              ),
            ),
            Text('+${formatPrice(item.unitPrice)}',
                style: TyType.sans(resp.sp(13),
                    color: ty.ink2, weight: FontWeight.w700)),
            SizedBox(width: resp.w(12)),
